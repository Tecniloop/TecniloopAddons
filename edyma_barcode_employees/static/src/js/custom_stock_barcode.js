...
export class MainMenuCustom extends Component {
    ...
    async _submitBarcode() {
        ...
        try {
            ...
            console.log("Nombre guardado en localStorage:", employeeName);
...
//        const barcode = this.state.manualInput;
//
//        const result = await jsonrpc("/web/dataset/call_kw/hr.employee/search_read", {
//                model: "hr.employee",
//                method: "search_read",
//                args: [
//                    [["application_code_barcode", "=", barcode]],
...
//                const employeeName = result[0].name;
//                localStorage.setItem('employeeName', employeeName);
//                console.log("Empleado encontrado y verificado:", employeeName);
//                console.log("Empleado encontrado y verificado :", employeeName);
//                this.state.employeeName = employeeName;
//            } else {
//                this.state.employeeName = "Empleado no encontrado.";
//            }
//
//            if (result.length > 0) {
//                const employeeName = result[0].name;
