...
""",
    ...
    'depends': ['product', 'website_sale', 'website_blog', 'website_sale_product_description', 'product_dimension', 'tl_product_package_dimensions', 'queue_job', 'brand', 'website_sale_product_attachment'],
