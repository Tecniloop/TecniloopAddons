...
class SitemapConnectorBicicletasQuerEs(models.AbstractModel):
    ...
    def get_product_entries(self, source, category_filter=None, limit=0):
        ...
        # El mapa HTML se consulta siempre: un sitemap válido puede ser parcial y
        # no incluir categorías completas (por ejemplo, cestas y accesorios).
        ...
        if result:
            return result
        raise ValueError(
            'No se pudieron descubrir productos de Bicicletas Quer ni por sitemap '
