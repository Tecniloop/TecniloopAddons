...
SELECT
    ...
    aal_pt.categ_id AS product_category_id,
...
LEFT JOIN product_product aal_product
    ON aal_product.id = al.product_id
LEFT JOIN product_template aal_pt
    ON aal_pt.id = aal_product.product_tmpl_id
