...
PRODUCTOS_GET_ALL_FECHA_MOD = '{}/articulo/getbycaracandfecha'
...
class A3erpProductos(models.Model):
    ...
    def get_products_by_fecha_mod(self, fecha_mod, campo):
        """
        Recibir productos a partir de una fecha de modificación de una CAR.
        """
        self.env['a3erp.replogs'].getall_records('productos', PRODUCTOS_GET_ALL_FECHA_MOD, self._name, 'codart', fecha_mod=fecha_mod, campo=campo)
